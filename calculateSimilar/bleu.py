...
#     reference = ['i like have a apple','the quick brown fox jumped over the lazy dog',
#                  'the brown fox jumped over the lazy dog']
#     candidate = 'the quick have a fox jumped over'
...
#     bleu_v2_score = my_bleu_v2(candidate, reference, 4, weights=[0.25, 0.25, 0.25, 0.25], mode=0)
#     print('bleu version 2 score is',bleu_v2_score)

if __name__ == '__main__':
    reference = [['i', 'like'],
                 ['the', 'quick', 'brown', 'fox', 'jumped', 'over', 'the', 'lazy', 'dog'],
                 ['the', 'brown', 'fox', 'jumped', 'over', 'the', 'lazy', 'dog']]
    candidate = ['the', 'quick', 'fox']
    s = SmoothingFunction()
    # score = corpus_bleu(reference, candidate)
    score = sentence_bleu(reference, candidate, smoothing_function=s.method1) # 默认是四等分
    print(score)